...
// To avoid this, the curved sections of the a??oa??, a??aa?? and a??da?? are oval shapes. 
...
// For example the tails for a??ha??, a??aa??, a??da??, a??ta??, the left hand side of the a??ya?? and the 
// top of the a??ha?? all use the same shape! 
// I was probably more happy that I should have been when I realised I could share
// the shape making the curve of the a??ra?? with the little loop on the a??oa??.
//
// I experimented with a distance field version but it looked like it would involve 
// a lot more work and I thought Ia??d already spent too much time on this shader :)
