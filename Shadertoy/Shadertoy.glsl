...
// •Ï”yˆÈŠO‚É‚à‰Šú‰»‚³‚ê‚Ä‚¢‚È‚¢•Ï”‚Í‚ ‚é‚ªAyˆÈŠO‚à‰Šú‰»‚·‚é‚Æ•Ô‚Á‚Ä‚¤‚¬‚áB‚Æ‚È‚éB
// i‚æ‚­‚í‚©‚è‚á‚ñ_(^_^)^j
...
//    return march(from, lookat(normalize(carpos2 - from)) * normalize(vec3(uv, 1.2 + sm(85., 86.) - sm(90., 91.)))).rgbr * sm(1., 3.) * sm(117.5, 115.5);
    vec4 col = march(from, lookat(normalize(carpos2 - from)) * normalize(vec3(uv, 1.2 + sm(85., 86.) - sm(90., 91.)))).rgbr * sm(1., 3.) * sm(117.5, 115.5);
