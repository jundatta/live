...
function setup() {
  createCanvas(1120, 678);// middle xaxis- 560 yaxis- 339
  ...
  noStroke()
    //left cloud
    let T = random(0, 300)
    let U = random(300, 510)

    fill(64, 67, 60, 150)//雲
    rect(T, U, 150, 200)

    let T2 = random(0, 300)
    let U2 = random(300, 510)
    //雲
    rect(T2, U2, 150, 200)

    let T3 = random(0, 300)
    let U3 = random(300, 510)

    rect(T3, U3, 150, 200)

    let T4 = random(0, 300)
    let U4= random(300, 510)

    rect(T4, U4, 150, 200)

    let T5 = random(0, 300)
    let U5 = random(300, 510)//雲

    rect(T5, U5, 150, 200)
    let T6 = random(0, 300)
    let U6 = random(300, 510)

    rect(T6, U6, 150, 200)

    let T7 = random(0, 300)
    let U7 = random(300, 510)
    ...
    let R = random(600, 1120)
    let S = random(300, 510)

    fill(64, 67, 60, 150)
    rect(R, S, 150, 200)

    let R2 = random(600, 1120)
    let S2 = random(300, 510)


    rect(R2, S2, 150, 200)

    let R3 = random(600, 1120)
    let S3 = random(300, 510)

    rect(R3, S3, 150, 200)

    let R4 = random(600, 1120)
    let S4= random(300, 510)


    rect(T4, U4, 150, 200)

    let R5 = random(600, 1120)
    let S5 = random(300, 510)

    rect(R5, S5, 150, 200)

    let R6 = random(600, 1120)
    let S6 = random(300, 510)

    rect(T6, U6, 150, 200)

    let R7 = random(600, 1120)
    let S7 = random(200, 540)
    ...
    let I4 = random(170, 400)
    let V4 = random(13, 200)
    rect(I4, V4, 70, 50)

    ///////////////////////////////////
    //top right clouds
    let C = random(600, 1000)
    let D = random(13, 200)
    ...
    let C4 = random(170, 400)
    let D4 = random(13, 200)
    rect(I4, V4, 70, 50)
